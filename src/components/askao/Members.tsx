          ...
          {preview.map((m) => (
            ...
            >
              <img
                ...
                alt={m.name}
                loading="lazy"
                className="max-h-16 max-w-[80%] object-contain opacity-70 transition-all duration-500 group-hover:opacity-100 group-hover:scale-105"
                style={{ filter: "brightness(0) invert(1)" }}
              />
              <div className="pointer-events-none absolute inset-x-0 bottom-0 translate-y-full bg-navy-deep/95 p-3 text-xs text-foreground transition-transform duration-300 group-hover:translate-y-0 border-t border-primary/40">
